...
/***
 * which behaves like an Adapter with view types and view recycling.
 * 
 */
public abstract class RecyclingPagerAdapter extends PagerAdapter {
	 ...
	 * {@link #getView}. If the adapter always returns the same type of View for
	 * all items, this method should return 1.
	 *
	 ...
	 *            the correct data, this method can create a new_w view.
