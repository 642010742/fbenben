...
import com.dwz.library.utils.refreshLayout.footer.BallPulseView;
import com.dwz.library.utils.refreshLayout.header.GoogleDotView;
import com.dwz.library.utils.refreshLayout.processor.AnimProcessor;
import com.dwz.library.utils.refreshLayout.processor.IDecorator;
import com.dwz.library.utils.refreshLayout.processor.OverScrollDecorator;
import com.dwz.library.utils.refreshLayout.processor.RefreshProcessor;
 ...
 * @DWZ
 */
public class XRefreshLayout extends RelativeLayout implements PullListener, NestedScrollingChild {
    //波浪的高度,最大扩展高度
    ...
    public XRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.XRefreshLayout, defStyleAttr, 0);
        try {
            mMaxHeadHeight = a.getDimensionPixelSize(R.styleable.XRefreshLayout_tr_max_head_height, (int) DensityUtil.dp2px(context, 120));
            mHeadHeight = a.getDimensionPixelSize(R.styleable.XRefreshLayout_tr_head_height, (int) DensityUtil.dp2px(context, 80));
            mMaxBottomHeight = a.getDimensionPixelSize(R.styleable.XRefreshLayout_tr_max_bottom_height, (int) DensityUtil.dp2px(context, 120));
            mBottomHeight = a.getDimensionPixelSize(R.styleable.XRefreshLayout_tr_bottom_height, (int) DensityUtil.dp2px(context, 60));
            mOverScrollHeight = a.getDimensionPixelSize(R.styleable.XRefreshLayout_tr_overscroll_height, (int) mHeadHeight);
            enableRefresh = a.getBoolean(R.styleable.XRefreshLayout_tr_enable_refresh, true);
            enableLoadmore = a.getBoolean(R.styleable.XRefreshLayout_tr_enable_loadmore, true);
            isPureScrollModeOn = a.getBoolean(R.styleable.XRefreshLayout_tr_pureScrollMode_on, false);
            isOverScrollTopShow = a.getBoolean(R.styleable.XRefreshLayout_tr_overscroll_top_show, true);
            isOverScrollBottomShow = a.getBoolean(R.styleable.XRefreshLayout_tr_overscroll_bottom_show, true);
            enableOverScroll = a.getBoolean(R.styleable.XRefreshLayout_tr_enable_overscroll, true);
            floatRefresh = a.getBoolean(R.styleable.XRefreshLayout_tr_floatRefresh, false);
            autoLoadMore = a.getBoolean(R.styleable.XRefreshLayout_tr_autoLoadMore, false);
            enableKeepIView = a.getBoolean(R.styleable.XRefreshLayout_tr_enable_keepIView, true);
            showRefreshingWhenOverScroll = a.getBoolean(R.styleable.XRefreshLayout_tr_showRefreshingWhenOverScroll, true);
            showLoadingWhenOverScroll = a.getBoolean(R.styleable.XRefreshLayout_tr_showLoadingWhenOverScroll, true);
        } finally {
            a.recycle();
        }
    ...
    public class CoContext {
        ...
        public void onPullingDown(float offsetY) {
            pullListener.onPullingDown(XRefreshLayout.this, offsetY / mHeadHeight);
        }

        public void onPullingUp(float offsetY) {
            pullListener.onPullingUp(XRefreshLayout.this, offsetY / mBottomHeight);
        }

        public void onRefresh() {
            pullListener.onRefresh(XRefreshLayout.this);
        }

        public void onLoadMore() {
            pullListener.onLoadMore(XRefreshLayout.this);
        }
        ...
        public void onPullDownReleasing(float offsetY) {
            pullListener.onPullDownReleasing(XRefreshLayout.this, offsetY / mHeadHeight);
        }

        public void onPullUpReleasing(float offsetY) {
            pullListener.onPullUpReleasing(XRefreshLayout.this, offsetY / mBottomHeight);
        }

        public boolean dispatchTouchEventSuper(MotionEvent ev) {
            return XRefreshLayout.super.dispatchTouchEvent(ev);
        }
