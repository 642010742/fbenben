...
import com.dwz.library.utils.refreshLayout.ScrollingUtil;
import com.dwz.library.utils.refreshLayout.listener.XRefreshLayout;
...
public class AnimProcessor implements IAnimRefresh, IAnimOverScroll{
    private XRefreshLayout.CoContext cp;
    private static final float animFraction = 1f;
    //动画的变化率
    private DecelerateInterpolator decelerateInterpolator;

    public AnimProcessor(XRefreshLayout.CoContext coProcessor) {
        this.cp = coProcessor;
    ...
    public void animBottomBack(final boolean isFinishLoading) {
        ...
        animLayoutByTime(getVisibleFootHeight(), 0, new ValueAnimator.AnimatorUpdateListener() {
            @Override
