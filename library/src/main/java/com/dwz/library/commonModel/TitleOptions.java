...
public class TitleOptions extends BaseModel {
    ...
    @ColorRes
    public int titleBackgroudColor = ContextCompat.getColor(AppContexts.App(), R.color.white);
    ...
    @SuppressLint("ResourceType")
    @ColorRes
    public int rightColor = ContextCompat.getColor(AppContexts.App(),R.color.c1c1c1d);

    // title 左边颜色
    @SuppressLint("ResourceType")
    @ColorRes
    public int leftColor = ContextCompat.getColor(AppContexts.App(),R.color.c1c1c1d);

    //  title 中间颜色
    @SuppressLint("ResourceType")
    @ColorRes
    public int centerColor = ContextCompat.getColor(AppContexts.App(),R.color.f3f3f3);
