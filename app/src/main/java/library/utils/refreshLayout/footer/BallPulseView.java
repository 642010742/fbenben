package library.utils.refreshLayout.footer;
...
import library.utils.refreshLayout.listener.IBottomView;
...
public class BallPulseView extends View implements IBottomView {
    ...
    public BallPulseView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(default_size, default_size, Gravity.CENTER);
