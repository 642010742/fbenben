...
public class StringUtils {
	...
	public static SpannableStringBuilder getText(TextView textView, Context context, int length){
				...
				ForegroundColorSpan redSpan = new ForegroundColorSpan(context.getResources().getColor(R.color.ffffff));
				ForegroundColorSpan redSpan1 = new ForegroundColorSpan(context.getResources().getColor(R.color.colorAccent));
				ForegroundColorSpan redSpan2 = new ForegroundColorSpan(context.getResources().getColor(R.color.ffffff));
